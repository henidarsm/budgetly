    ...
    <div class="register-right">
        <div class="register-form-box">
            ...
            <form method="POST" action="{{ route('register.post') }}">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="business_name" class="form-control" placeholder="Nama usaha Anda (opsional)" value="{{ old('business_name') }}">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="phone" class="form-control" placeholder="08xxxxxxxxxx (opsional)" value="{{ old('phone') }}">
                    </div>
                </div>
            ...
            <div class="text-center mt-3">
                <a href="{{ route('login') }}" style="color:#1565C0;font-weight:600;text-decoration:none;font-size:15px;">
