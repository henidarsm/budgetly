...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> - Budgetly</title>
...
<div class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-item-custom">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link-custom <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">
        ...
        <div class="nav-item-custom">
            <a href="<?php echo e(route('admin.users.index')); ?>" class="nav-link-custom <?php echo e(request()->routeIs('admin.users.*') ? 'active' : ''); ?>">
                <i class="fas fa-users"></i> Data Pengguna
            </a>
        </div>
        <div class="nav-item-custom">
            <a href="<?php echo e(route('admin.expenses.index')); ?>" class="nav-link-custom <?php echo e(request()->routeIs('admin.expenses.*') ? 'active' : ''); ?>">
                <i class="fas fa-receipt"></i> Semua Pengeluaran
            </a>
        </div>
        <div class="nav-item-custom">
            <a href="<?php echo e(route('admin.categories.index')); ?>" class="nav-link-custom <?php echo e(request()->routeIs('admin.categories.*') ? 'active' : ''); ?>">
    ...
    <div class="sidebar-footer">
        <div class="user-info">
            ...
            <div class="user-details">
                <div class="name"><?php echo e(Str::limit(auth()->user()->name, 14)); ?></div>
    ...
    <div class="topbar">
        <div class="d-flex align-items-center gap-3">
            ...
            <div class="topbar-title">
                ...
                <p><?php echo $__env->yieldContent('page-subtitle', 'Selamat datang di panel admin Budgetly'); ?></p>
            </div>
        </div>
        <div class="topbar-right">
            <div class="d-none d-md-flex align-items-center gap-2 px-3 py-2 rounded-3" style="background:#F0F4FF;">
                <img
                    src="https://images.unsplash.com/photo-<?php echo e($myAvatarId); ?>?w=64&h=64&fit=crop&crop=face"
                    class="rounded-circle" width="32" height="32" alt="<?php echo e(auth()->user()->name); ?>"
                    style="object-fit:cover;"
                >
                <div>
                    <div style="font-size:13px;font-weight:600;color:#1E293B;"><?php echo e(Str::limit(auth()->user()->name, 18)); ?></div>
...
<?php /**PATH C:\laragon\www\budgetly bismillah ga error\resources\views/layouts/admin.blade.php ENDPATH**/ ?>