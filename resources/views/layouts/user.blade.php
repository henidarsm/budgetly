...
<head>
    ...
    <title>@yield('title', 'Dashboard') - Budgetly</title>
...
<div class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-item-custom">
            <a href="{{ route('user.expenses.index') }}" class="nav-link-custom {{ request()->routeIs('user.expenses.*') ? 'active' : '' }}">
                <i class="fas fa-receipt"></i> Pengeluaran
            </a>
        </div>
        <div class="nav-item-custom">
            <a href="{{ route('user.categories.index') }}" class="nav-link-custom {{ request()->routeIs('user.categories.*') ? 'active' : '' }}">
                <i class="fas fa-tags"></i> Kategori
            </a>
        </div>
        <div class="nav-item-custom">
            <a href="{{ route('user.reports.index') }}" class="nav-link-custom {{ request()->routeIs('user.reports.*') ? 'active' : '' }}">
    ...
    <div class="sidebar-footer">
        <div class="user-info">
            ...
            <div class="user-details">
                ...
                <div class="role">{{ auth()->user()->business_name ?? 'Pengguna' }}</div>
            </div>
    ...
    <div class="topbar">
        <div class="d-flex align-items-center gap-3">
            ...
            <div class="topbar-title">
                ...
                <p>@yield('page-subtitle', 'Kelola keuangan usaha Anda')</p>
            </div>
        </div>
        <div class="d-flex align-items-center gap-3">
            <a href="{{ route('user.expenses.create') }}" class="btn-primary-custom d-none d-md-flex" style="border-radius:10px;padding:9px 16px;font-size:13px;">
